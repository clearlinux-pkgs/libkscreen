...
Source0  : https://download.kde.org/stable/plasma/5.24.3/libkscreen-5.24.3.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.24.3/libkscreen-5.24.3.tar.xz.sig
...
%prep
%setup -q -n libkscreen-5.24.3
cd %{_builddir}/libkscreen-5.24.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1647270002
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/libkscreen-5.24.3/LICENSES/GPL-2.0-only.txt %{buildroot}/usr/share/package-licenses/libkscreen/3e8971c6c5f16674958913a94a36b1ea7a00ac46
cp %{_builddir}/libkscreen-5.24.3/LICENSES/GPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/libkscreen/3e8971c6c5f16674958913a94a36b1ea7a00ac46
cp %{_builddir}/libkscreen-5.24.3/LICENSES/GPL-3.0-only.txt %{buildroot}/usr/share/package-licenses/libkscreen/2123756e0b1fc8243547235a33c0fcabfe3b9a51
cp %{_builddir}/libkscreen-5.24.3/LICENSES/LGPL-2.1-or-later.txt %{buildroot}/usr/share/package-licenses/libkscreen/81b58c89ceef8e9f8bd5d00a287edbd15f9d3567
cp %{_builddir}/libkscreen-5.24.3/LICENSES/LicenseRef-KDE-Accepted-GPL.txt %{buildroot}/usr/share/package-licenses/libkscreen/7d9831e05094ce723947d729c2a46a09d6e90275
cp %{_builddir}/libkscreen-5.24.3/LICENSES/LicenseRef-KDE-Accepted-GPL.txt %{buildroot}/usr/share/package-licenses/libkscreen/7d9831e05094ce723947d729c2a46a09d6e90275
pushd clr-build
%make_install
popd
...
%files lib
%defattr(-,root,root,-)
/usr/lib64/libKF5Screen.so.5.24.3
