...
Version  : 5.27.6
Release  : 86
URL      : https://download.kde.org/stable/plasma/5.27.6/libkscreen-5.27.6.tar.xz
Source0  : https://download.kde.org/stable/plasma/5.27.6/libkscreen-5.27.6.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.27.6/libkscreen-5.27.6.tar.xz.sig
...
%prep
%setup -q -n libkscreen-5.27.6
cd %{_builddir}/libkscreen-5.27.6
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1687280679
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKF5Screen.so.5.27.6
/V3/usr/lib64/libKF5ScreenDpms.so.5.27.6
...
/usr/lib64/libKF5Screen.so.5.27.6
/usr/lib64/libKF5Screen.so.8
/usr/lib64/libKF5ScreenDpms.so.5.27.6
