...
%prep
%setup -q -n libkscreen-5.27.0
cd %{_builddir}/libkscreen-5.27.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1676671015
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/usr/lib64/libKF5Screen.so.5.27.0
/usr/lib64/libKF5Screen.so.8
/usr/lib64/libKF5ScreenDpms.so.5.27.0
