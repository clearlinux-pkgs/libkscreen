...
Version  : 6.1.1
Release  : 102
URL      : https://download.kde.org/stable/plasma/6.1.1/libkscreen-6.1.1.tar.xz
Source0  : https://download.kde.org/stable/plasma/6.1.1/libkscreen-6.1.1.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.1.1/libkscreen-6.1.1.tar.xz.sig
...
%setup -q -n libkscreen-6.1.1
cd %{_builddir}/libkscreen-6.1.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1719413736
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKF6Screen.so.6.1.1
/V3/usr/lib64/libKF6ScreenDpms.so.6.1.1
...
/usr/lib64/libKF6Screen.so.6.1.1
/usr/lib64/libKF6Screen.so.8
/usr/lib64/libKF6ScreenDpms.so.6.1.1
