...
Source0  : https://download.kde.org/stable/plasma/6.3.5/libkscreen-6.3.5.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.3.5/libkscreen-6.3.5.tar.xz.sig
...
%setup -q -n libkscreen-6.3.5
cd %{_builddir}/libkscreen-6.3.5
pushd ..
cp -a libkscreen-6.3.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1747079782
mkdir -p clr-build
pushd clr-build
...
/usr/share/locale/nb/LC_MESSAGES/libkscreen6_qt.qm
...
/usr/share/locale/sv/LC_MESSAGES/libkscreen6_qt.qm
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKF6Screen.so.6.3.5
/V3/usr/lib64/libKF6ScreenDpms.so.6.3.5
...
/usr/lib64/libKF6Screen.so.6.3.5
/usr/lib64/libKF6Screen.so.8
/usr/lib64/libKF6ScreenDpms.so.6.3.5
