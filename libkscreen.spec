...
Version  : 5.13.4
Release  : 1
URL      : https://download.kde.org/stable/plasma/5.13.4/libkscreen-5.13.4.tar.xz
Source0  : https://download.kde.org/stable/plasma/5.13.4/libkscreen-5.13.4.tar.xz
...
export LANG=C
export SOURCE_DATE_EPOCH=1535149443
mkdir clr-build
pushd clr-build
%cmake ..
make  %{?_smp_mflags}
...
%files lib
%defattr(-,root,root,-)
/usr/lib64/libKF5Screen.so.5.13.4
