...
Source0  : https://download.kde.org/stable/plasma/6.3.2/libkscreen-6.3.2.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.3.2/libkscreen-6.3.2.tar.xz.sig
...
%setup -q -n libkscreen-6.3.2
cd %{_builddir}/libkscreen-6.3.2
pushd ..
cp -a libkscreen-6.3.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1740592843
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKF6Screen.so.6.3.2
/V3/usr/lib64/libKF6ScreenDpms.so.6.3.2
...
/usr/lib64/libKF6Screen.so.6.3.2
/usr/lib64/libKF6Screen.so.8
/usr/lib64/libKF6ScreenDpms.so.6.3.2
