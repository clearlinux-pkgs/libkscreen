...
Source0  : https://download.kde.org/stable/plasma/5.13.5/libkscreen-5.13.5.tar.xz
Source99 : https://download.kde.org/stable/plasma/5.13.5/libkscreen-5.13.5.tar.xz.sig
Summary  : Qt Based library to manage screens with backends (xrandr, whatevercomesnext)
Group    : Development/Tools
License  : GPL-2.0
Requires: libkscreen-bin
Requires: libkscreen-lib
Requires: libkscreen-data
Requires: libkscreen-license
...
export LANG=C
export SOURCE_DATE_EPOCH=1536088278
mkdir clr-build
pushd clr-build
%cmake ..
make  %{?_smp_mflags}
...
export SOURCE_DATE_EPOCH=1536088278
rm -rf %{buildroot}
mkdir -p %{buildroot}/usr/share/doc/libkscreen
cp COPYING %{buildroot}/usr/share/doc/libkscreen/COPYING
cp COPYING.LIB %{buildroot}/usr/share/doc/libkscreen/COPYING.LIB
pushd clr-build
%make_install
popd
...
%files lib
%defattr(-,root,root,-)
/usr/lib64/libKF5Screen.so.5.13.5
...
%files license
%defattr(-,root,root,-)
/usr/share/doc/libkscreen/COPYING
/usr/share/doc/libkscreen/COPYING.LIB
