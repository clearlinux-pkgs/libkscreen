...
Source0  : https://download.kde.org/stable/plasma/5.19.2/libkscreen-5.19.2.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.19.2/libkscreen-5.19.2.tar.xz.sig
...
%prep
%setup -q -n libkscreen-5.19.2
cd %{_builddir}/libkscreen-5.19.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1592938943
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/libkscreen-5.19.2/COPYING %{buildroot}/usr/share/package-licenses/libkscreen/4cc77b90af91e615a64ae04893fdffa7939db84c
cp %{_builddir}/libkscreen-5.19.2/COPYING.LIB %{buildroot}/usr/share/package-licenses/libkscreen/4cc77b90af91e615a64ae04893fdffa7939db84c
pushd clr-build
%make_install
popd
...
%files lib
%defattr(-,root,root,-)
/usr/lib64/libKF5Screen.so.5.19.2
