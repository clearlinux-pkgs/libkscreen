...
Version  : 6.1.2
Release  : 103
URL      : https://download.kde.org/stable/plasma/6.1.2/libkscreen-6.1.2.tar.xz
Source0  : https://download.kde.org/stable/plasma/6.1.2/libkscreen-6.1.2.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.1.2/libkscreen-6.1.2.tar.xz.sig
...
%setup -q -n libkscreen-6.1.2
cd %{_builddir}/libkscreen-6.1.2
pushd ..
cp -a libkscreen-6.1.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720540518
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKF6Screen.so.6.1.2
/V3/usr/lib64/libKF6ScreenDpms.so.6.1.2
...
/usr/lib64/libKF6Screen.so.6.1.2
/usr/lib64/libKF6Screen.so.8
/usr/lib64/libKF6ScreenDpms.so.6.1.2
