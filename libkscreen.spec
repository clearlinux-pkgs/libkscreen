...
Source0  : https://download.kde.org/stable/plasma/5.27.9/libkscreen-5.27.9.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.27.9/libkscreen-5.27.9.tar.xz.sig
...
%prep
%setup -q -n libkscreen-5.27.9
cd %{_builddir}/libkscreen-5.27.9
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1698278249
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKF5Screen.so.5.27.9
/V3/usr/lib64/libKF5ScreenDpms.so.5.27.9
...
/usr/lib64/libKF5Screen.so.5.27.9
/usr/lib64/libKF5Screen.so.8
/usr/lib64/libKF5ScreenDpms.so.5.27.9
